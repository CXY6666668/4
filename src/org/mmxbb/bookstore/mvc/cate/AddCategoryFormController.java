 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AddCategoryFormController extends AbstractCategoryFormController {

	  	    
	    protected static Log log = LogFactory.getLog(AddCategoryFormController.class);
		...
		protected ModelAndView onSubmit(Object command) throws ServletException {
		    ...
		    getCategoryService().createCategory(obj);
